...
class EventDetailContainer extends PureComponent {
  ...
  renderMeta = item => {
    switch (item.type) {
      case "map":
        return this.renderMetaMap(item);
      case "term":
        return this.renderMetaTerm(item);
      case "website":
        return this.renderMetaWebsite(item);
      case "email":
        return this.renderMetaEmail(item);
      case "phone":
        return this.renderMetaPhone(item);
      default:
        return false;
    }
  };
